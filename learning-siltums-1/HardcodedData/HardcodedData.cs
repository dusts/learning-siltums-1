...
namespace learning_siltums_1.HardcodedData
{
    public class HardcodedData
    {
        ...
        static string s2_a1 = $"Kurināmie ir vielas, kuras sadedzinot var iegūt sultumu, dabā iegustamas lielos daudzumos un degšanas produkti nav pārāk kaitīgi. Tos iedala:\n -> Pēc izcelsmes: dabiskie (iegūst izrokot vai iegūstot koksni) un mākslīgie (ar iepriekšēju apstrādi)\n -> Pēc agregātstāvokļa: cieti, šķidri un gāzveida\n -> Pēc sastāva: organiskie, metāliskie, kodolkurināmie\n -> Pēc veidošanās procesa ilguma: fosilie kurināmie, bio-kurināmie\nKurināmā sastāvs:\n -> Darba sastāvs - C{needsSuperscript}d{needsSuperscript} + H{needsSuperscript}d{needsSuperscript} + S{needsSuperscript}d{needsSuperscript} + N{needsSuperscript}d{needsSuperscript} + O{needsSuperscript}d{needsSuperscript} + W{needsSuperscript}d{needsSuperscript} = 100%\n -> Sausais sastāvs - C{needsSuperscript}s{needsSuperscript} + H{needsSuperscript}s{needsSuperscript} + S{needsSuperscript}s{needsSuperscript} + N{needsSuperscript}s{needsSuperscript} + O{needsSuperscript}s{needsSuperscript} + A{needsSuperscript}s{needsSuperscript} = 100%\n -> Degošais sastāvs - C{needsSuperscript}dg{needsSuperscript} + H{needsSuperscript}dg{needsSuperscript} + S{needsSuperscript}dg{needsSuperscript} + N{needsSuperscript}dg{needsSuperscript} + O{needsSuperscript}dg{needsSuperscript} = 100%";
        static string s2_q2 = $"Kurināmo degšanas reakcijas. Gaisa pārpilnības koeficients.";
        static string s2_a2 = $"Pakāpeniska C (oglekļa) degšana:\n C + 0.5O{subscript2} = CO + 29409 kcal/kmol\n CO + 0.5O{subscript2} = CO{subscript2} + 67591 kcal/kmol\n     Kopā: 97000 kcal/kmol\nTiešā C (oglekļa) degšana:\n C + O{subscript2} = CO{subscript2} + 97000 kcal/kmol\nS degšana:\n S + 0.5O{subscript2} = SO{subscript2} + 70860 kcal/kmol\nH{subscript2} degšana:\n H{subscript2} + 0.5O{subscript2} = H{subscript2}O + kcal/kmol (ūdens šķidrā veidā)\nGaisa pārpalikuma jeb pārpilnības koeficients {smallAlphaChar} (alfa) (air excess factor) parāda, cik reizes vairāk gaisa nekā teorētiski nepieciešams jāpievada kurtuvei, lai būtu pilnīga sadegšana.\n(no prezentācijas)";
        static string s2_q3 = $"Kurināmā augstākā un zemākā sildspēja. To noteikšana. Nosacītais kurināmais.";
        static string s2_a3 = $"Kurināmā augstākā sildspēja Q{needsSubscript}A{needsSubscript} (siltumspēja, sadegšanas siltums) (angl. Calorific value) ir siltuma daudzums, ko var iegūt pilnībā sadedzinot vienu kg (vai 1m{supscript3}) kurināmā.\nKurināmā zemāko sildspēju Q{needsSubscript}z{needsSubscript} iegūst no augstākās sildspējas atņemot siltuma daudzumu, kas tiek patērēts kurināmā esošā mitruma iztvaikošanai.\n Q{needsSubscript}z{needsSubscript} = Q{needsSubscript}A{needsSubscript} - Q{needsSubscript}W{needsSubscript}\n Q{needsSubscript}W{needsSubscript} = 25*(9H{needsSuperscript}d{needsSuperscript} + W{needsSuperscript}d{needsSuperscript}).\nNosacītais kurināmais (conventional fuel) kalpo, lai varētu salīdzināt dažādus kurināmos.\n -> Ogļu ekvivalents (CE - coal equivalent): tas ir pieņemts kurināmais, kura sildspēja ir pielīdzināta labām akmeņoglēm un ir vienāda ar 29300 kJ/kg (jeb 7000 kcal/kg)\n -> Naftas ekvivalents (Toe - tonne of oil equivalent): tas ir pieņemts lielums, lai salīdzinātu enerģijas daudzumu, izmantojot dažādus kurināmos ar dažādām sildspējām un arī elektroenerģiju, 1Toe ir ekvivalents enerģijas daudzumam 41898GJ jeb 11630 MWh.\n(no prezentācijas)";
        static string s2_q4 = $"Akmeņogles: to veidi, izcelsme, sastāvs, sildspēja.";
        static string s2_a4 = $"-Veidi:\n -- Brūnogles (lignīts, degakmens, degslānis). Satur daudz ūdens un pelnu, samērā maz oglekļa, zema sildspēja\n -- Akmeņogles veidojas no brūnoglēm ap 3km dziļumā\n -- Antracīts veicojas līdz 6km dziļumā, satur līdz 96% oglekļa, dod sevišķi daudz siltuma, taču grūti uzliesmo.\nAkmeņogles veidojas apstākļos, kuros augu atliekas uzrkājas ātrāk nekā notiek to sadalīšanās baktēriju iedarbībā. Parasti šādi apstākļi ir purvos. Sākotnējā ogļu veidošanās stadija ir kūdra. Tai nokļūstot zem citiem nogulumiežiem spiediena iedarbībā no kūdras izdalās ūdens un gāzes. Zēmāka spiediena ietekmē veidojas brūnogles, augstāka spiediena un temperatūras ietekmē - akmeņogles un antracīts.\nAkmeņogļu sastāvs:\n - vidējais gaistošo vielu saturs sasniedz 35-40%\n - pelnu saturs 2-45%\n - mitruma saturs 4-15%\n - sildspēja no 2500 (brūnoglēm) līdz 7200 (antracītam) kcal/kg\n - S 0.3-7%\n - C 75-97%\n - H{subscript2} 1.5 - 5.7%\n - O{subscript2} 1.5 - 15%\n - N{subscript2} līdz 1.5%\n- Iedalījums pēc gaistošo savienjumu satura (gaistošo vielu sastāvā ir pirmdarva (brūnogles), akmeņogļu darva (akmeņoglēs) un gāzes: oglekļa oksīds, ūdeņradis, metāns, viegli gaistošie ogļudeņraži un citi):\n - Brūnogles 45-55%\n - Garliesmas 45-55%\n - Gāzes 30-45%\n - Treknās 15-30%\n - Liesās 4-15%\n - Antracīts 0-4%\n - Kokss 0-4%\n(no prezentācijas)";
        static string s2_q5 = $"Kūdra: tās izcelsme, ieguve, sastāvs, sildspēja. Kūdras briketes.";
        static string s2_a5 = $"Kūdra veidojas apstākļos, kuros augu atliekas uzkrājas ātrāk nekā notiek to sadalīšanās baktēriju iedarbībā. Parasti šādi apstākļi ir purvos. Iegūst virs zemes ar traktortehniku.\nSastāvs:\n -Slapjai kūdrai\n -- pelnu saturs 0.1-2%\n -- mitruma saturs 85-96%\n -Gaissaisai kūdrai\n -- pelnu saturs 0.4-9%\n -- mitruma saturs 20-30%\n -- sēra saturs līdz 0.5%.\nAptuvenais degošais sastāvs:\n -- Ogleklis C - 50%\n -- Ūdeņradis H{subscript2} - 6%\n -- Skābeklis O{subscript2} - 33%\n -- Slāpeklis N{subscript2} - 1.5%\n -- Sērs S - 0.5%\nSildspēja gaissausai kūdrai 2300-3500 kcal/kg\nBlīvums 330-400 kg/m{supscript3}\nKūdras briketes iegūšt no frēzkūdras 1.2 MPa spiedienā. Īpašības:\n -- Q{needsSubscript}Z{needsSubscript}=4300-4600 kcal/kg\n -- Pelnu saturs 6-15%\n -- Mitrums 10-17%\n -- Sērs aptuveni 0.02-0.3%\n -- Blīvums 800-1100 kg/m{supscript3}";
        static string s2_q6 = $"Koksnes kurināmie: to sastāvs, sildspēja, mitrums.";
        static string s2_a6 = $"Malka, kokskaidu granulas, šķelda.\nSildspēja 19100 kJ/kg.\nMalka ir koksnes kurināmais.\nSvaigi cirstai malkai W=40-80% un Q{needsSubscript}Z{needsSubscript}=1600-1800 kcal/kg.\nGadu žāvētai malkai W=15-20% un Q{needsSubscript}Z{needsSubscript}=3000-3500 kcal/kg.\nMalka sastāv no C-50%, H{subscript2}-6%, O{subscript2}-44%, N{subscript2};S-0%. A-0.1-0.5%.\nSausas malkas svars no 350-540kg/m3.";
        static string s2_q7 = $"Naftas pārtvaice, tajā iegūtie produkti, to izmantošana.";
        static string s2_a7 = $"Naftas pārtvaice (fizikālais) – atdala frakcijas noteiktā iztvaikošanas t diapazonā\nNaftas pārtveicē iegūst: gāzi (piedevas benzīnam, sintēt. Produktiem), benzīnu, ligroīnu, petroleju, gazoilu, solāreļļu, mazutu. No mazuta tālāk iegūst vieglās industriālās eļļas, vidējās industriālās eļļas, motoreļļas, smagās industriālās eļļas un gudronu.";
        ...
        static string s2_a8 = $"-Frakcijas:\n -- Vieglās frakcijas - uzlabo iedarbināšanu pie zemām temperatūrām.\n -- Darba frakcijas\n -- Smagās frakcijas\n -Īpašības:\n -- Blīvums 690-770 kg/m{needsSuperscript}3{needsSuperscript};\n -- viskozitāte v=0.65 cst;\n -- Q{needsSubscript}Z{needsSubscript}=42500 ... 44000 kJ/kg (10500 kcal/kg).\n -Markas:\n -- 95.\n -- 98.\n -- Latvijā marku nosaukumā norāda pētniecisko oktānskaitli. Jo augstāks oktānskaitlis, jo augstāka izturība pret detonāciju.\n -Oktānskaitlis: oktānskaitlis atbilst izooktāna daudzumam etalonmaisījumā, procentos.\n -Oktānskaitļa noteikšana: lai noteiktu oktānskaitli izmanto 2 metodes:\n -- Ar motormetodi (MOS) uz stenda ar maināmu kompresijas pakāpi. Palielina komresiju, līdz sākas pašaizdegšanās. Tad salīdzina ar etalonmaisījumu, kas sastāv no izooktāna C{needsSubscript}8{needsSubscript}H{needsSubscript}18{needsSubscript}, kas ļoti grūti detonē, un normālhektāna C{needsSubscript}7{needsSubscript}H{needsSubscript}16{needsSubscript}, kas ļoti ātri detonē.\n -- Ar pētniecisko metodi (POS) analizējot sastāvu.\n -- Rezultāti atšķiras - nosakot ar metormedoi oktānskaitlis ir nedaudz mazāks, nekā ar pētniecisko.\n -- Lai paaugstinātu oktānskailti, lieto piedevas. Kādreiz lietoja tetraetilsvinu, kas ir ļoti indīgs. Mūsdienās lieto metabutilēteri (MTBE) un obligātās biopiedevas - metilspirtu vai etilspirtu.\n -- Pētnieciskais oktānskaitlis raksturo benzīna veiktspēju zemas slodzes apstākļos, savukārt motora oktānskaitlis – augstas slodzes apstākļos.\n -Sastāvs:\n -- svins (max 5mg/l),\n -- sērs (max 10 mg/kg),\n -- mangāns (max 2 mg/l),\n -- sveķi (max 5 mg/100ml),\n -- ogļūdeņraži (olefīni max 18% tilpuma, aromātiskie ogļūdeņraži max 35% tilpuma),\n -- benzanols (max 1% tilpuma),\n -- skābeklis (max 2.7% masas),\n -- metanols (max 3% tilpuma),\n -- etanols (max 5% tilpuma),\n -- izopropilspirts, izobutilspirts, tercobutilspirts, ēteri (5 un vairāk C atomi) un citi skābekļa savienojumi (max 2.7% tilpuma)\n";
        static string s2_q9 = $"Dīzeļdegviela, tās īpašības, markas. Sastāvs. Cetānskaitlis.";
        static string s2_a9 = $"Dīzeļdegvielas sadegšana noris 4 etapos: aizdegšanās aizkavēšanās periods, ātras degšanas periods, lēnas degšanas periods, atlikuma sadegšana.\n -Īpašības:\n -- Blīvums=820-860 kg/m{supscript3}.\n -- Viskozitāte=1.5-8 cst.\n -- Q{needsSubscript}Z{needsSubscript}=42.5-44 MJ/kg.\n-Markas:\n\n-Sastāvs:\n\n-Cetānskaitlis:\n--Cetānskaitlis raksturo aizdegšanās aizkavēšanās periodu. TO nosaka uz stenda, salīdzinot ar etalonu, kurš sastāv no cetāna C{needsSubscript}16{needsSubscript}H{needsSubscript}34{needsSubscript} un {smallAlphaChar}-metil-naftalīna C{needsSubscript}10{needsSubscript}H{needsSubscript}7{needsSubscript}CH{needsSubscript}3{needsSubscript}. Cetānskaitlis ir robežās no 50-55 (45). Jo mazāks Cetānskaitlis, jo lielāks ir aizdegšanās aizkavējuma noilgums.\n";
        static string s2_q10 = $"Mazuts un šķidrais krāšņu kurināmais (destilāts), sastāvs, īpašības, ieguve, izmantošana.";
        static string s2_a10 = $"Mazuts ir naftas pāŗstrādes procesa starpprodukts, starp vieglākajām un smagākajām frakcijām.\nQ{needsSubscript}Z{needsSubscript}=402000-42000 kJkg.\nPastāv arī flotes jeb kuģu mazuts. To markas ir F5 līdz F12 ar viskozitāti no 5-12 cst.\nDēļ lielās viskozitātes mazuts ir jāsilda, lai varētu padot uz kurināmo katlu (t=80-100).\nMazutam ir diezgan liels sēra (S) saturs -> S=0.15-3.5%, kā arī liels ūdens dadzums, kas pirms padeves uz degli ir jāatdala, nostādinot. Krāšņu kurināmo iegūšt destilējot dažādas naftas frakcijas pārstrādes procesā. Tas ir augstvērtīgs kurināmais ar augstu sildspēju Q{needsSubscript}Z{needsSubscript}=10150 kcal/kg. Tam ir zema viskozitāte, to nevajag uzsildīt un zems sēra saturs -> S=0.003-0.03%.\n";
        static string s2_q11 = $"Metilspirts, tā iegūšana, īpašības, izmantošana.";
        static string s2_a11 = $"Metilspirtu iegūst lapu koku destruktīvā destilācijā jeb termiski sadalot koksni. Koksnes sadalīšana notiek slēgtā iekārtā pakāpeniski paagustinoties temperatūrai no 160 līdz 450 grādiem. Siltums jāpievada, lai sāktos reakcija. Tālākā procesā siltums tiek izdalīts. Reakcijā rodas degoša gāze (var izmantot apsildei), šķidrums (satur 1-6% CH{needsSubscript}3{needsSubscript}OH, 9-12% CH{needsSubscript}3{needsSubscript}COOH (etiķskābe) un 0.1-0.5% CH{needsSubscript}3{needsSubscript}COOCH{needsSubscript}3{needsSubscript} (acetona), bet pārējais ir H{subscript2}0. Pāri paliek cietā frakcija jeb koka ogle. Tālāk veicot šķidruma seperāciju un destilāciju iegūšt no 92 līdz 95% metilspirta. Lai iegūtu augstāku spirta saturu, to ķīmiski apstrādā ar CaCl{subscript2}.\n\n";
