...
namespace learning_siltums_1.HardcodedData
{
    public class HardcodedData
    {
        ...
        static string s2_a5 = $"Kūra veidojas apstākļos, kuros augu atliekas uzkrājas ātrāk nekā notiek to sadalīšanās baktēriju iedarbībā. Parasti šādi apstākļi ir purvos. Iegūst virs zemes ar traktortehniku.\nSastāvs: slapjai kūdrai";
